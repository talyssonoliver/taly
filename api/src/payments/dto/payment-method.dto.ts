...
export class CreatePaymentMethodDto {
  ...
  @ApiPropertyOptional({ description: 'Card details (required if type is card)' })
  @IsOptional()
  @ValidateNested()
  @Type(() => CreateCardPaymentMethodDto)
  card?: CreateCardPaymentMethodDto;

  @ApiPropertyOptional({ description: 'Bank account details (required if type is bank_account)' })
  @IsOptional()
  @ValidateNested()
  ...
  @ApiPropertyOptional({ description: 'Whether this is the default payment method' })
  @IsOptional()
  @IsBoolean()
  isDefault?: boolean;
...
export class PaymentMethodResponseDto {
  ...
  @ApiPropertyOptional({ description: 'External payment method ID in payment processor' })
  externalId?: string;
