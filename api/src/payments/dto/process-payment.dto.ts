...
export class ProcessPaymentDto {
  ...
  @ApiPropertyOptional({ description: 'Card details (required if paymentMethodType is card)' })
  @IsOptional()
  @ValidateNested()
  @Type(() => CardDetailsDto)
  cardDetails?: CardDetailsDto;

  @ApiPropertyOptional({ description: 'Bank account details (required if paymentMethodType is bank_account)' })
  @IsOptional()
  @ValidateNested()
  @Type(() => BankAccountDetailsDto)
  bankAccountDetails?: BankAccountDetailsDto;

  @ApiPropertyOptional({ description: 'Payment token (required if paymentMethodType is payment_token)' })
  @IsOptional()
  @ValidateNested()
  @Type(() => PaymentTokenDto)
  paymentToken?: PaymentTokenDto;

  @ApiPropertyOptional({ description: 'Payment method ID if using a saved payment method' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'Whether to save payment method for future use' })
  @IsOptional()
  @IsBoolean()
  savePaymentMethod?: boolean;

  @ApiPropertyOptional({ description: 'Subscription ID if payment is for a subscription' })
  @IsOptional()
  @IsString()
  subscriptionId?: string;

  @ApiPropertyOptional({ description: 'Invoice ID if payment is for an invoice' })
  @IsOptional()
  @IsString()
  invoiceId?: string;
  ...
  @ApiPropertyOptional({ description: 'Return URL for redirect after successful payment' })
  @IsOptional()
  @IsString()
  successUrl?: string;

  @ApiPropertyOptional({ description: 'Return URL for redirect after failed payment' })
  @IsOptional()
  @IsString()
  cancelUrl?: string;
}
